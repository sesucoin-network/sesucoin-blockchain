...
from sesucoin.pools.pool_config import PoolWalletConfig
from sesucoin.util.config import load_config, save_config, create_default_sesucoin_config
...
def test_pool_config():
    ...
    create_default_sesucoin_config(test_root, ["config.yaml"])
