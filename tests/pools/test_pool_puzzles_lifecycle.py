...
from sesucoin.wallet.puzzles.p2_conditions import puzzle_for_conditions
from sesucoin.wallet.puzzles import singleton_top_layer
from sesucoin.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - sesucoin.pools.pool_puzzles.py
    - sesucoin.wallet.puzzles.pool_member_innerpuz.clvm
    - sesucoin.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
