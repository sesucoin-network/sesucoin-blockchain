...
from sesucoin.plotting.util import stream_plot_info_ph, stream_plot_info_pk, PlotRefreshResult, PlotRefreshEvents
from sesucoin.plotting.manager import PlotManager
from sesucoin.protocols import farmer_protocol
from sesucoin.rpc.farmer_rpc_api import FarmerRpcApi
from sesucoin.rpc.farmer_rpc_client import FarmerRpcClient
from sesucoin.rpc.harvester_rpc_api import HarvesterRpcApi
from sesucoin.rpc.harvester_rpc_client import HarvesterRpcClient
from sesucoin.rpc.rpc_server import start_rpc_server
...
from sesucoin.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "xss"), encode_puzzle_hash(new_ph_2, "xss"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "xss"))
            ...
            assert config["farmer"]["xss_target_address"] == encode_puzzle_hash(new_ph, "xss")
            assert config["pool"]["xss_target_address"] == encode_puzzle_hash(new_ph_3, "xss")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "xss")
