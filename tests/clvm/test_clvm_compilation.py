...
wallet_program_files = set(
    [
        "sesucoin/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "sesucoin/wallet/puzzles/cc.clvm",
        "sesucoin/wallet/puzzles/chialisp_deserialisation.clvm",
        "sesucoin/wallet/puzzles/rom_bootstrap_generator.clvm",
        "sesucoin/wallet/puzzles/generator_for_single_coin.clvm",
        "sesucoin/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "sesucoin/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "sesucoin/wallet/puzzles/lock.inner.puzzle.clvm",
        "sesucoin/wallet/puzzles/p2_conditions.clvm",
        "sesucoin/wallet/puzzles/p2_delegated_conditions.clvm",
        "sesucoin/wallet/puzzles/p2_delegated_puzzle.clvm",
        "sesucoin/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "sesucoin/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "sesucoin/wallet/puzzles/p2_puzzle_hash.clvm",
        "sesucoin/wallet/puzzles/rl_aggregation.clvm",
        "sesucoin/wallet/puzzles/rl.clvm",
        "sesucoin/wallet/puzzles/sha256tree_module.clvm",
        "sesucoin/wallet/puzzles/singleton_top_layer.clvm",
        "sesucoin/wallet/puzzles/did_innerpuz.clvm",
        "sesucoin/wallet/puzzles/decompress_puzzle.clvm",
        "sesucoin/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "sesucoin/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "sesucoin/wallet/puzzles/block_program_zero.clvm",
        "sesucoin/wallet/puzzles/test_generator_deserialize.clvm",
        "sesucoin/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "sesucoin/wallet/puzzles/p2_singleton.clvm",
        "sesucoin/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "sesucoin/wallet/puzzles/pool_member_innerpuz.clvm",
        "sesucoin/wallet/puzzles/singleton_launcher.clvm",
        "sesucoin/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["sesucoin/wallet/puzzles/create-lock-puzzlehash.clvm", "sesucoin/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "sesucoin/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to sesucoin/wallet/puzzles, but not added to `wallet_program_files`
        """
