...
export const defaultPlotter = (): Plotter => {
  return {
    displayName: "Sesucoin Proof of Space",
    options: optionsForPlotter(PlotterName.SESUCOINPOS),
    defaults: defaultsForPlotter(PlotterName.SESUCOINPOS),
...
const initialState: PlotterConfigurationState = {
  availablePlotters: {
    [PlotterName.SESUCOINPOS]: defaultPlotter(),
  },
