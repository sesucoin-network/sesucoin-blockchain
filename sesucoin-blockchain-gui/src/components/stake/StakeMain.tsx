...
import { Flex, Form, InputBase, Loading, More, Amount } from '@sesucoin/core';
...
import { sesucoin_to_mojo, mojo_to_sesucoin} from '../../util/sesucoin';
...
export default function StakeMain() {
    ...
    function dealSearchResult(records:any[]):string {
      ...
      let total_sesucoin: number = mojo_to_sesucoin(total);
      return "Staking Balance: " + total_sesucoin.toLocaleString();
    }
    ...
    return (
        <Flex flexDirection="column" gap={3}>
          ...
          Please select your staking address and send XSS to it.
          </Typography>
