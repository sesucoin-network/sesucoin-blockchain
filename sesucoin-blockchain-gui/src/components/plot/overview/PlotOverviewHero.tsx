...
import { CardHero, Flex, Link } from '@sesucoin/core';
import { PlotHero as PlotHeroIcon } from '@sesucoin/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Sesucoin. '
              }
              <Link
                target="_blank"
                href="https://github.com/sesucoin-network/sesucoin-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
