...
import { CardStep, Select } from '@sesucoin/core';
import {
  FormControl,
  FormHelperText,
  Grid,
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    displayablePlotters.sort((a, b) => a == PlotterName.SESUCOINPOS ? -1 : a.localeCompare(b));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Sesucoin Proof of Space plotter. If unsure,
            use the default Sesucoin Proof of Space plotter.
        </Trans>
      </Typography>
