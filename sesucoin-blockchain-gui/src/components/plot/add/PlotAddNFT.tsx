...
import { Button, CardStep, Select, Flex, Loading } from '@sesucoin/core';
import {
  Box,
  Grid,
  FormControl,
  ...
  if (showCreatePlotNFT) {
    return (
      <PlotNFTSelectPool
        ...
        description={
          <Trans>
            Join a pool and get consistent SESUCOIN farming rewards. The average
    ...
    >
      ...
      {!loading && !hasNFTs && (
        <>
          <Typography variant="subtitle1">
            <Trans>
              Join a pool and get more consistent SESUCOIN farming rewards. Create a
