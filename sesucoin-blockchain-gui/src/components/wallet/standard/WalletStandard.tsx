...
import {
  ...
  Fee,
  Form,
  TextField as SesucoinTextField,
  AlertDialog,
  CopyToClipboard,
  Flex,
  Card,
...
import { /* mojo_to_sesucoin_string, */ sesucoin_to_mojo } from '../../../util/sesucoin';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_sesucoin_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of sesucoin in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Sesucoin that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Sesucoin that you have just spent but is not
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      openDialog(
        <AlertDialog>
          <Trans>
            Error: Cannot send sesucoin to coloured address. Please enter a sesucoin
            address.
          </Trans>
        </AlertDialog>,
      );
    ...
    if (address.slice(0, 12) === 'sesucoin_addr://') {
    ...
    const amountValue = Number.parseFloat(sesucoin_to_mojo(amount));
    const feeValue = Number.parseFloat(sesucoin_to_mojo(fee));
