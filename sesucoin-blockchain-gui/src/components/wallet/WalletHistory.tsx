...
import { Card, CopyToClipboard, Flex, Table } from '@sesucoin/core';
import type { Row } from '../core/components/Table/Table';
import {
  mojo_to_sesucoin_string,
  ...
  },
  {
    field: (row: Row) =>
      type === WalletType.COLOURED_COIN
        ...
        : mojo_to_sesucoin_string(row.amount),
    title: <Trans>Amount</Trans>,
  },
  {
    field: (row: Row) => mojo_to_sesucoin_string(row.fee_amount),
