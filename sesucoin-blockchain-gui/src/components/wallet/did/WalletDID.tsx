...
import { AlertDialog, Card, Flex, Loading, Dropzone } from '@sesucoin/core';
import {
...
import { mojo_to_sesucoin_string } from '../../../util/sesucoin';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_sesucoin_string(props.balance)} TXSS
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const CreateAttest = (props) => {
  ...
  function createAttestPacket() {
    ...
    if (address.substring(0, 12) === 'sesucoin_addr://') {
...
const CashoutCard = (props) => {
  ...
  function cashout() {
    ...
    if (puzzlehash.slice(0, 12) === 'sesucoin_addr://') {
