...
import icon from '../../assets/img/sesucoin_circle.svg';
...
const url = 'https://www.sesucoin.eu';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2022 Sesucoin Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/sesucoin-network/sesucoin-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
