...
import { Flex, Form, InputBase } from '@sesucoin/core';
  ...
  return (
    <Flex flexDirection="column" gap={3}>
      ...
      <Typography variant="body1" color="textSecondary">
        Enter your Sesucoin pool contract address and NFT Launcher ID to recover the missing XSS from your plot NFT.
      </Typography>
