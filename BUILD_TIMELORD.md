...
required to run a [Timelord](https://github.com/sesucoin-network/sesucoin-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/sesucoin-network/sesucoin-blockchain/blob/main/install-timelord.sh)
