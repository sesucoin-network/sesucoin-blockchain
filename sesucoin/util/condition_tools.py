...
from sesucoin.types.blockchain_format.sized_bytes import bytes32, bytes48
...
def parse_sexp_to_condition(
    ...
    """
    Takes a sesucoinLisp sexp and returns a ConditionWithArgs.
...
def parse_sexp_to_conditions(
    ...
    """
    Takes a sesucoinLisp sexp (list) and returns the list of ConditionWithArgss
