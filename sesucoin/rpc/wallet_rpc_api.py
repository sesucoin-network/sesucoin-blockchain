...
from sesucoin.consensus.block_rewards import calculate_base_farmer_reward
from sesucoin.consensus.coinbase import create_puzzlehash_for_pk
from sesucoin.pools.pool_puzzles import SINGLETON_MOD_HASH, create_p2_singleton_puzzle
from sesucoin.pools.pool_wallet import PoolWallet
from sesucoin.pools.pool_wallet_info import FARMING_TO_POOL, PoolState, PoolWalletInfo, create_pool_state
from sesucoin.protocols.protocol_message_types import ProtocolMessageTypes
from sesucoin.server.outbound_message import NodeType, make_msg
from sesucoin.simulator.simulator_protocol import FarmNewBlockProtocol
from sesucoin.types.blockchain_format.coin import Coin
from sesucoin.types.blockchain_format.program import Program, SerializedProgram
from sesucoin.types.blockchain_format.sized_bytes import bytes32
from sesucoin.util.bech32m import decode_puzzle_hash, encode_puzzle_hash
from sesucoin.util.byte_types import hexstr_to_bytes
from sesucoin.util.config import load_config
from sesucoin.util.ints import uint32, uint64
from sesucoin.util.keychain import KeyringIsLocked, bytes_to_mnemonic, generate_mnemonic
from sesucoin.util.path import path_from_root
from sesucoin.util.ws_message import WsRpcMessage, create_payload_dict
...
from sesucoin.wallet.trade_record import TradeRecord
from sesucoin.wallet.transaction_record import TransactionRecord
from sesucoin.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from sesucoin.wallet.util.trade_utils import trade_record_to_dict
...
from sesucoin.wallet.wallet_info import WalletInfo
from sesucoin.wallet.wallet_node import WalletNode
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "sesucoin_wallet"
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "sesucoin_wallet", "wallet_ui")]
    ...
    async def _check_key_used_for_rewards(
        ...
        farmer_target = config["farmer"].get("xss_target_address")
        pool_target = config["pool"].get("xss_target_address")
        found_farmer = False
        found_pool = False
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from sesucoin.pools.pool_wallet_info import initial_pool_state_from_dict
