...
from sesucoin.consensus.network_type import NetworkType
from sesucoin.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from sesucoin.farmer.farmer import Farmer
from sesucoin.protocols import farmer_protocol, harvester_protocol
from sesucoin.protocols.harvester_protocol import PoolDifficulty
...
from sesucoin.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSsesucoinConnection
    ):
        """
    ...
    @api_request
    @peer_required
    async def new_signage_point(self, new_signage_point: farmer_protocol.NewSignagePoint, peer: ws.WSsesucoinConnection):
        try:
    ...
    @api_request
    @peer_required
    async def respond_plots(self, _: harvester_protocol.RespondPlots, peer: ws.WSsesucoinConnection):
