...
from sesucoin.daemon.server import service_launch_lock_path, singleton
from sesucoin.server.ssl_context import sesucoin_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        proctitle_name = f"sesucoin_{service_name}"
        ...
        sesucoin_ca_crt, sesucoin_ca_key = sesucoin_ssl_ca_paths(root_path, self.config)
        inbound_rlp = self.config.get("inbound_rate_limit_percent")
        outbound_rlp = self.config.get("outbound_rate_limit_percent")
        assert inbound_rlp and outbound_rlp
        self._server = sesucoinServer(
            advertised_port,
            node,
            peer_api,
            node_type,
            ...
            (sesucoin_ca_crt, sesucoin_ca_key),
    ...
    async def wait_closed(self) -> None:
        ...
        self._log.info("Waiting for sesucoinServer to be closed")
