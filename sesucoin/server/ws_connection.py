...
from sesucoin.cmds.init_funcs import sesucoin_full_version_str
from sesucoin.protocols.protocol_message_types import ProtocolMessageTypes
from sesucoin.protocols.protocol_state_machine import message_response_ok
from sesucoin.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from sesucoin.protocols.shared_protocol import Capability, Handshake
...
from sesucoin.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from sesucoin.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSsesucoinConnection:
    """
