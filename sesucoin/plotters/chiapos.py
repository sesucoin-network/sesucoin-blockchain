"""
NOTE: This contains duplicate code from `sesucoin.cmds.plots`.
After `sesucoin plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "sesucoin Proof of Space", "version": chiapos_version, "installed": True}
...
def plot_sesucoin(args, root_path):
