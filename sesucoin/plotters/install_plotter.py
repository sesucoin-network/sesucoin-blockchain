import os
from sesucoin.plotters.bladebit import install_bladebit
from sesucoin.plotters.madmax import install_madmax
...
def install_plotter(plotter, root_path):
    if plotter == "chiapos":
        ...
        if not os.path.exists(root_path / "madmax-plotter/build/sesucoin_plot"):
