...
from sesucoin.cmds.configure import configure_cmd
from sesucoin.cmds.farm import farm_cmd
from sesucoin.cmds.init import init_cmd
from sesucoin.cmds.keys import keys_cmd
from sesucoin.cmds.netspace import netspace_cmd
from sesucoin.cmds.passphrase import passphrase_cmd
from sesucoin.cmds.plotnft import plotnft_cmd
from sesucoin.cmds.plots import plots_cmd
from sesucoin.cmds.plotters import plotters_cmd
from sesucoin.cmds.show import show_cmd
from sesucoin.cmds.start import start_cmd
from sesucoin.cmds.stop import stop_cmd
from sesucoin.cmds.wallet import wallet_cmd
from sesucoin.util.default_root import DEFAULT_KEYS_ROOT_PATH, DEFAULT_ROOT_PATH
from sesucoin.util.keychain import set_keys_root_path, supports_keyring_passphrase
from sesucoin.util.ssl_check import check_ssl
...
@click.group(
    help=f"\n  Manage sesucoin blockchain infrastructure ({DIST_NAME} {__version__})\n",
    epilog="Try 'sesucoin start node', 'sesucoin netspace -d 192', or 'sesucoin show -s'",
...
def cli(
    ...
    if passphrase_file is not None:
        from sesucoin.cmds.passphrase_funcs import cache_passphrase, read_passphrase_from_file
