...
from sesucoin.util.keychain import Keychain, bytes_to_mnemonic, generate_mnemonic, unlocks_keyring
from sesucoin.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
from sesucoin.wallet.derive_chives_keys import master_sk_to_chives_farmer_sk, master_sk_to_chives_pool_sk, master_sk_to_chives_wallet_sk
...
def generate_and_print():
    ...
    print(mnemonic)
    print("Note that this key has not been added to the keychain. Run sesucoin keys add")
    return mnemonic
