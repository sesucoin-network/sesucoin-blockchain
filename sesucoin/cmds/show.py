...
async def show_async(
    ...
    from sesucoin.util.misc import format_bytes
    ...
    try:
        ...
        if state:
            ...
            if synced:
                ...
                print("You may be able to expedite with 'sesucoin show -a host:port' using a known node.\n")
        ...
        if add_connection:
            if ":" not in add_connection:
                print("Enter a valid IP and port in the following format: 10.5.4.3:40444")
            else:
                ip, port = (
