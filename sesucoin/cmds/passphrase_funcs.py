...
from sesucoin.daemon.client import acquire_connection_to_daemon
from sesucoin.util.keychain import Keychain, obtain_current_passphrase, supports_os_passphrase_storage
from sesucoin.util.keyring_wrapper import DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE
from sesucoin.util.misc import prompt_yes_no
from sesucoin.util.ws_message import WsRpcMessage
    ...
    try:
        if supports_os_passphrase_storage():
            ...
            print(
                ...
                "Other sesucoin processes will be able to access your keys without prompting for your passphrase."
            )
...
def initialize_passphrase() -> None:
    if Keychain.has_master_passphrase():
        ...
        print("\nUse 'sesucoin passphrase set' or 'sesucoin passphrase remove' to update or remove your passphrase")
        sys.exit(1)
