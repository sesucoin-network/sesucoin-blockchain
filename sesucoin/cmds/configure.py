...
from sesucoin.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "49444"
            # testnet_introducer = "beta1_sesu.ddns.net"
            # testnet_dns_introducer = "dns-introducer-testnet7.sesu.ddns.net"
            testnet = "testnet"
            ...
            mainnet_port = "40444"
            # mainnet_introducer = "sesu.ddns.net"
            # mainnet_dns_introducer = "sesu-introducer.ddns.net"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running sesucoin services for changes to take effect")
