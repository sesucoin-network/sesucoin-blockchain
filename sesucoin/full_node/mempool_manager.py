...
from sesucoin.full_node.mempool_check_conditions import mempool_check_conditions_dict, get_name_puzzle_conditions
...
from sesucoin.util.cached_bls import LOCAL_CACHE
from sesucoin.util.clvm import int_from_bytes
from sesucoin.util.condition_tools import pkm_pairs
from sesucoin.util.errors import Err, ValidationError
from sesucoin.util.generator_tools import additions_for_npc
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 XSS per block, or about 0.00005 SESUCOIN for two
        # spends.
