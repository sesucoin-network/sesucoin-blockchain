...
from sesucoin.consensus.block_body_validation import validate_block_body
from sesucoin.consensus.block_header_validation import validate_finished_header_block, validate_unfinished_header_block
...
from sesucoin.consensus.multiprocess_validation import (
    PreValidationResult,
    _run_generator,
    pre_validate_blocks_multiprocessing,
)
from sesucoin.consensus.pos_quality import UI_ACTUAL_SPACE_CONSTANT_FACTOR
...
from sesucoin.full_node.mempool_check_conditions import get_name_puzzle_conditions
...
from sesucoin.types.blockchain_format.vdf import VDFInfo
...
from sesucoin.types.generator_types import BlockGenerator, GeneratorArg
from sesucoin.types.header_block import HeaderBlock
from sesucoin.types.unfinished_block import UnfinishedBlock
from sesucoin.types.unfinished_header_block import UnfinishedHeaderBlock
from sesucoin.types.weight_proof import SubEpochChallengeSegment
from sesucoin.util.errors import ConsensusError, Err
from sesucoin.util.generator_tools import get_block_header, tx_removals_and_additions
from sesucoin.util.ints import uint16, uint32, uint64, uint128
from sesucoin.util.streamable import recurse_jsonify
    ...
    async def get_farmer_difficulty_coeff(
        ...
        if minimal_staking == 0 or staking < minimal_staking:
            ...
            if blocks == 0:
                ...
                # multiple 1000 to keep same scale as xss
